...
struct TamperCheckCatalog {
    ...
    bool expected_signing_certificate_lineage = false;
    bool expected_apk_signing_block_hash = false;
    bool expected_apk_signing_block_id_hashes = false;
    bool expected_apk_hash = false;
    bool expected_manifest_hash = false;
    bool expected_resources_arsc_hash = false;
    bool expected_resource_inventory_hash = false;
    bool expected_resource_entry_hashes = false;
    ...
    bool expected_component_access_semantics = false;
    bool expected_component_operational_semantics = false;
    ...
    bool expected_intent_filter_semantics_hashes = false;
    bool expected_grant_uri_permission_hashes = false;
    bool expected_grant_uri_permission_semantics_hashes = false;
    ...
    bool expected_uses_feature_field_values = false;
    ...
    bool expected_uses_sdk_field_values = false;
    bool expected_supports_screens_hash = false;
    bool expected_supports_screens_small_screens_hash = false;
    bool expected_supports_screens_normal_screens_hash = false;
    bool expected_supports_screens_large_screens_hash = false;
    bool expected_supports_screens_xlarge_screens_hash = false;
    bool expected_supports_screens_resizeable_hash = false;
    bool expected_supports_screens_any_density_hash = false;
    bool expected_supports_screens_requires_smallest_width_dp_hash = false;
    bool expected_supports_screens_compatible_width_limit_dp_hash = false;
    bool expected_supports_screens_largest_width_limit_dp_hash = false;
    bool expected_compatible_screens_hash = false;
    bool expected_compatible_screens_screen_size_hash = false;
    bool expected_compatible_screens_screen_density_hash = false;
    bool expected_uses_library_hash = false;
    bool expected_uses_library_name_hash = false;
    bool expected_uses_library_required_hash = false;
    bool expected_uses_library_field_values = false;
    bool expected_uses_library_only_hash = false;
    bool expected_uses_library_only_name_hash = false;
    bool expected_uses_library_only_required_hash = false;
    bool expected_uses_native_library_hash = false;
    bool expected_uses_native_library_name_hash = false;
    bool expected_uses_native_library_required_hash = false;
    bool expected_uses_native_library_field_values = false;
    bool expected_queries_hash = false;
    bool expected_queries_package_hash = false;
    bool expected_queries_package_name_hash = false;
    bool expected_queries_package_semantics_hash = false;
    bool expected_queries_provider_hash = false;
    bool expected_queries_provider_authority_hash = false;
    bool expected_queries_provider_semantics_hash = false;
    ...
    bool expected_queries_intent_semantics_hash = false;
    bool expected_application_semantics = false;
    bool expected_application_fields = false;
    bool expected_metadata_type = false;
    bool expected_metadata_value_hash = false;
    bool expected_manifest_metadata_entry_hashes = false;
    bool expected_manifest_metadata_semantics_hashes = false;
