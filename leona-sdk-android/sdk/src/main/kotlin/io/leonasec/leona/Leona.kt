...
object Leona {
    ...
    fun getDiagnosticSnapshot(): LeonaDiagnosticSnapshot {
        ...
        return LeonaDiagnosticSnapshot(
            ...
            fingerprintSchemaVersion = identity.fingerprintSchemaVersion,
            fingerprintSource = identity.fingerprintSource,
            identityAnchorSource = identity.identityAnchorSource,
            canonicalDeviceIdSource = identity.canonicalDeviceIdSource,
