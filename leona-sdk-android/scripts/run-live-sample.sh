...
: "${LEONA_REPORTING_ENDPOINT:?LEONA_REPORTING_ENDPOINT is required. Use the customer Leo-protected reporting endpoint.}"
...
path = sys.argv[1]
secret_keys = {"LEONA_API_KEY", "LEONA_E2E_TOKEN"}
pattern = re.compile(
    r'public static final String '
    r'(LEONA_(?:API_KEY|TENANT_ID|REPORTING_ENDPOINT|CLOUD_CONFIG_ENDPOINT|'
    r'E2E_TOKEN|SAMPLE_ATTESTATION_MODE|SAMPLE_PLAY_INTEGRITY_CLOUD_PROJECT_NUMBER))'
    r' = "(.*)";'
)
