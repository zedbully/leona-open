...
echo "  1. Real-device false-positive regression"
echo "  2. Backend canonicalDeviceId / cloud-config regression"
echo "  3. Sample app diagnostics/verdict/support-bundle sanity check"
